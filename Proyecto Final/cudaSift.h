...
typedef struct {
  ...
  SiftPoint *h_data;  // Host data
  SiftPoint *d_data;  // Device data
...
void ExtractSift(SiftData &siftData, CudaImage &img, int numOctaves, double initBlur, float thresh, float lowestScale = 0.0f, float *tempMemory = 0);
