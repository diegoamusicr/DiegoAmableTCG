...
__global__ void FindMaxCorr(SiftPoint *sift1, SiftPoint *sift2, int numPts1, int numPts2)
{
...
#define TESTHOMO_TESTS 16
#define TESTHOMO_LOOPS 16
...
double MatchSiftData(SiftData &data1, SiftData &data2)
{
  ...
  FindMaxCorr<<<blocksMax3, threadsMax3>>>(sift1, sift2, numPts1, numPts2);
